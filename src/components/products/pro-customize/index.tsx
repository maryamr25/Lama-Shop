  ...
  return (
     <div className="flex flex-col gap-6">
      ...
      {/* <ul className="flex items-center gap-3">
          ...
          <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 cursor-not-allowed relative bg-purple-800 ">
            <div className="absolute w-10 h-[2px] bg-red rotate-45 rounded-full  top-1/2 left-1/2 transform -translate-x-1/2  -translate-y-1/2  "></div>
          </li>
        </ul> */} 
